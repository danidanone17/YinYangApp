...
public class DatabaseAdapterValidation extends
	...
	public void testDesc(){
		...
		ArrayList<Post> posts = db.getQuestionsByFreeTextAndTags(searchWords, tags, SearchResultSortingAlgorithm.QuestionScoreAlgorithm);
	...
	public void testGetQuestionByFreeTextAndTags1(){
		...
		ArrayList<Post> resultedPosts = db.getQuestionsByFreeTextAndTags(oWords, oTags, SearchResultSortingAlgorithm.QuestionScoreAlgorithm);
